...
function ProjectModal() {
  ...
  const { setOpenProjectModal, projName } = state;
  ...
  return (
    <section className="proj_modal fixed w-[90%] h-[95vh] top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] z-[100] rounded-xl bg-gray-50 dark:bg-gray-700 dark:text-gray-50  text-5xl overflow-auto ">
      <i
        className="fa-solid fa-xmark absolute top-5 lg:top-6 right-6 lg:right-8 text-2xl lg:text-3xl cursor-pointer z-[100] text-gray-50 lg:text-gray-800"
        onClick={() => setOpenProjectModal(false)}
      ></i>
      <div className="grid grid-cols-1 grid-rows-[1fr,1.5fr]  lg:grid-cols-[2.5fr,1fr] lg:grid-rows-1 h-full">
        <div
        ...
        <div className="py-10 lg:py-20 px-6 lg:px-12">
          ...
          <p className="mb-6 text-xl  lg:text-2xl leading-[1.6] lg:leading-[1.8]  text-gray-600 dark:text-gray-300 text-justify  indent-[3rem]">
            {findProject.description}
          </p>
          <p className="text-xl lg:text-2xl  font-bold  text-gray-700 dark:text-gray-50 mb-4">
            Technologies
          </p>
