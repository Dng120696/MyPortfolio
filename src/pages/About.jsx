...
function About() {
  return (
    <section
      id="about"
      className="w-[clamp(30rem,90%,120rem)]  m-auto  h-min lg:h-screen py-32 lg:py-0 grid lg:grid-cols-2 gap-32 border-b-[1px] dark:border-gray-600 border-gray-300"
    >
      ...
      <div className=" flex items-center justify-center flex-col">
        ...
        <article className="pt-[3rem] self-start">
          <h1 className="text-[2rem] font-bold text-gray-800 dark:text-gray-200 mb-8 uppercase">
            Skills
          </h1>
          <div className="text-2xl md:text-3xl lg:text- border-[1px] dark:border-gray-500 border-gray-300 p-6 md:p-10 rounded-md grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-3 gap-y-8 gap-x-14 lg:gap-6 text-gray-600 dark:text-gray-300">
