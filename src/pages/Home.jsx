...
function Home({ children }) {
  return (
    <div className="  text-2xl flex items-center justify-center " id="home">
      {children}
      <section className="w-[clamp(30rem,90%,120rem)]  m-auto flex items-center justify-between flex-col-reverse md:flex-row h-min md:h-screen  border-b-[1px] py-40 md:py-0  gap-20 md:gap-0 dark:border-gray-600 border-gray-300">
        <article>
          <p className="text-gray-400 dark:text-gray-400 font-medium mb-4 md:mb-6 lg:mb-10">
            Hi <strong className="text-3xl">👋</strong>, my name is
          </p>
          <h1 className="font-bold text-5xl md:text-6xl lg:text-7xl text-gray-900 dark:text-gray-100 mb-8">
